...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  //GPIOB14,B15设置
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_14 | GPIO_Pin_15;//PA14/15复用功能输出	
...
//  USB_HOST_PWRCTRL=1;			//开启USB HOST电源供电
	...
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource14,GPIO_AF_OTG_FS);//PA14,AF10(USB)
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource15,GPIO_AF_OTG_FS);//PA15,AF10(USB)
}
