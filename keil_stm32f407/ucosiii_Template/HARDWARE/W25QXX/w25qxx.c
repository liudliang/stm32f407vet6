...
//创建日期:2020/05/12
//版本：V1.0			
//描述：W25Q128特性：容量为16M字节,共有128个Block,4096个Sector；16个扇区为1个Block，
//      4Kbytes为一个Sector
////////////////////////////////////////////////////////////////////////////////// 	
...
** 输　出: 
** 全局变量:
** 描述: 只有SPR,TB,BP2,BP1,BP0(bit 7,5,4,3,2)可以写!!!
*/
...
/*
** 函数名称: 
** 功能描述: 无检验写SPI FLASH,必须确保所写的地址范围内的数据全部为0XFF,否则在非0XFF处
             写入的数据将失败!具有自动换页功能 
** 输　入: 
						pBuffer:数据存储区
						WriteAddr:开始写入的地址(24bit)
...
** 输　出: 
** 全局变量:
** 描述: 在指定地址开始写入指定长度的数据,但是要确保地址不越界!
*/
