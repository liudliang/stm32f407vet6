...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /* HCLK = SYSCLK / 1*/
    RCC->CFGR |= RCC_CFGR_HPRE_DIV1;   //1·ÖÆµ£¬HPREÊÇAHB¸ßËÙÔ¤·ÖÆµÆ÷£¨APB2£¬×î´ó168MHz£©

#if defined (STM32F40_41xxx) || defined (STM32F427_437xx) || defined (STM32F429_439xx)      
    /* PCLK2 = HCLK / 2*/
    RCC->CFGR |= RCC_CFGR_PPRE2_DIV2;  //2·ÖÆµ£¬PPRE2ÊÇAPB¸ßËÙÔ¤·ÖÆµÆ÷£¨APB2£¬×î´ó84MHz£©
    
    /* PCLK1 = HCLK / 4*/
    RCC->CFGR |= RCC_CFGR_PPRE1_DIV4;  //4·ÖÆµ£¬PPRE1ÊÇAPBµÍËÙÔ¤·ÖÆµÆ÷£¨APB1£¬×î´ó42MHz£©
#endif /* STM32F40_41xxx || STM32F427_437x || STM32F429_439xx */
...
//ÅäÖÃÖ÷PLLµÄ²ÎÊý£¬ÏµÍ³Ê±ÖÓSYSCLK£»ËøÏà»·Ñ¹Ç»Õñµ´Æ÷Ê±ÖÓPLL_VCO£»
//USB£¬SD¿¨£¬OTG FSÊ±ÖÓÎªÊ¹ USB OTG FS ÄÜ¹»Õý³£¹¤×÷£¬ÐèÒª 48 MHz µÄÊ±ÖÓ¡£¶ÔÓÚ SDIO ºÍËæ¼´ÊýÉú³ÉÆ÷£¬ÆµÂÊÐèÒªµÍÓÚ»òµÈÓÚ 48 MHz ²Å¿ÉÕý³£¹¤×÷¡£
//SYSCLK£¨×î´ó168MHz£©¡¢PLL_VCO£¨192~432MHz£©¡¢HSE_VALUE / PLL_M£¨1~2MHz,½¨Òé2MHz£©¡¢PLL_M(2~63)¡¢PLL_P(2¡¢4¡¢6¡¢8)¡¢PLL_N£¨192~432£©
//PLL_Q(2~15)


//¼ÆËã¹«Ê½£º
//USB,SD¿¨Ê±ÖÓ = PLL_VCO / PLL_Q
//SYSCLK = PLL_VCO / PLL_P
//PLL_VCO = (HSE_VALUE / PLL_M) * PLL_N


//´ËÊµÑé£ºÍâ²¿¾§ÕñHSE_VALUE=25MHz£¬PLL_M=25£¬PLL_N=336£¬PLL_P=2£»PLL_Q=7;
//ÔòÏµÍ³Ê±ÖÓÎª168MHz£¬HCLK²»·ÖÆµÎª168MHz£»PLCK2=84MHz£»PCLK1=42MHz£»USB£¬SD¿¨£¬OTG FSÊ±ÖÓÆµÂÊÎª48MHz


//ÀýÈç2£ºÍâ²¿¾§ÕñHSE_VALUE=8MHz£¬PLL_M=8£¬PLL_N=336£¬PLL_P=2£»
//ÔòÏµÍ³Ê±ÖÓÎª168MHz£¬HCLK²»·ÖÆµÎª168MHz£»PLCK2=84MHz£»PCLK1=42MHz£»USB£¬SD¿¨£¬OTG FSÊ±ÖÓÆµÂÊÎª48MHz
