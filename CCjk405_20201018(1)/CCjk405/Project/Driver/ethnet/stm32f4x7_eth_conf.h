...
#define USE_Delay
  ...
  #define _eth_delay_    Main_Delay   /* User can provide more timing precise _eth_delay_ function 
...
/* Redefinition of the Ethernet driver buffers size and count */
 ...
 #define ETH_RXBUFNB        4  // 4                  /* 4 Rx buffers of size ETH_RX_BUF_SIZE */
 #define ETH_TXBUFNB        4  // 4                    /* 4 Tx buffers of size ETH_TX_BUF_SIZE */
#endif
