...
/** @addtogroup Configuration Registers 
  * @{
  */
...
/** @addtogroup Bit Timing Configuration 
  * @{
  */
/* CNF1 */ 
#define SJW_1TQ         0x40 
...
/** @addtogroup Control/Configuration Registers  
  * @{
  */
/* CANINTE */ 
...
typedef enum 
{ 
	CAN_STD  = (uint8_t)0x00,
	CAN_EXTD = (uint8_t)0x08,			 
	CAN_RTR  = (uint8_t)0x40 
